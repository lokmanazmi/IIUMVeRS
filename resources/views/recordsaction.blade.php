        ...
        <div class="row content">
            ...
            <div class="col-sm-8 text-left">
                ...
                <div class="col-sm-8 text-left">
                    ...
                    <div>
                            <table>
                                ...
                                <form action="/revoke/{{ $applicants[0]->username }}" method="POST">
                                {{ csrf_field() }}
                                    <tr>
                                        <th>Revoke Reason:</th>
                                        <td><input type="text" class="form-control" name="revokedReason" id="revokedReason" placeholder="State a reason of revoking" :value="old('revokedReason')" required autofocus></td>
                                    </tr>
                            </table>
                    </div>
                ...
                <div class="approvalButton1">
                        <button type="submit" name="submit" class="btn btn-default" style="background-color: #003D7B; color:white; margin-top:100px" value="Revoke">Revoke</button>
                </form>
                </div>
                <div class="approvalButton2">
                        <button class="btn btn-default" style="background-color:grey; margin-left:3px; margin-top: 0px; margin-bottom: 50px" value="Return"><a href="{{ route('records') }}" style="color:white">Return</a></button>
                </div>   
