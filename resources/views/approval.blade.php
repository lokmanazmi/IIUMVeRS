        ...
        <div class="row content">
            ...
            <div class="col-sm-8 text-left">
                ...
                <div class="col-sm-8 text-left">
                    ...
                    <form action="/approve/{{ $applicants[0]->username }}" method="POST">
                                    <tr>
                                        <th>Sticker No:</th>
                                        <td><input type="text" class="form-control" name="stickerNo" id="stickerNo" placeholder="Assign a sticker number" :value="old('stickerNo')" required autofocus></td>
                                    </tr>
                                    <tr>
                                        <th>Expired Date:</th>
                                        <td><input type="date" class="form-control" name="expDate" id="expDate"  required autofocus></td>
                                    </tr>
                            </table>
                    </div>
                ...
                <div class="approvalButton1">
                    {{ csrf_field() }}
                        <button type="submit" name="submit" class="btn btn-default" style="background-color: #003D7B; color:white; margin-top:100px" value="Approve">Approve</button>
                    </form>
                </div>
                <div class="approvalButton2">
                    <form action="/reject/{{ $applicants[0]->username }}" method="POST">
                    {{ csrf_field() }}
                        <button type="submit" name="submit" class="btn btn-default" style="background-color: #003D7B; color:white; margin-left:6px" value="Reject">Reject</button>
                    </form>
                </div>   
