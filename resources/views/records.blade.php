        ...
        @endif  
            <div class="row content">
                ...
                <div class="col-sm-8 text-left">
                    ...
                    <button style="background-color: #003D7B ; color: #fff">Approved Applicants</button>
                    <button style="background-color: #fff"><a href="{{ route('rejectedrecords') }}">Rejected Applicants</a></button>
                    ...
                    <!--Applicants List-->
                        ...
                        @foreach($data as $row)   
                                <tr>
                                    ...
                                    <td>{{ $row->status }}</td>
                                    <td>{{ $row->stickerNo }}</td>
                                    <td>{{ $row->expDate->format('d-m-Y')}}</td>
                                    <td><a href="recordsaction/{{$row->username}}">Revoke</a></td>
                                </tr>
                            @endforeach
                        </table>
                        <br>
